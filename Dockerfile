...
#
# Single image serving BOTH transports of the vgi-etf-jpmorgan worker:
...
ARG SOURCE_URL=https://github.com/Query-farm/vgi-etf-jpmorgan

LABEL org.opencontainers.image.title="vgi-etf-jpmorgan" \
      org.opencontainers.image.description="J.P. Morgan Asset Management US ETF data as a VGI worker for DuckDB/SQL (stdio + HTTP)" \
